	...
	<div class="siteorigin-panels-builder">
		...
		<div class="so-panels-welcome-message">
			<div class="so-message-wrapper">
                ...
                printf(
                    __( 'Add a %s, %s or %s to get started.', 'siteorigin-panels' ), // TUT Customization
...
<script type="text/template" id="siteorigin-panels-dialog-prebuilt">
	<div class="dialog-data">
		...
		<div class="left-sidebar">
			...
			<ul class="so-sidebar-tabs">
<?php /* // START - TUT Customization - Remove "Theme Defined" section from pre-built latout.
...
*/ // END - TUT Customization - Remove "Theme Defined" section from pre-built latout. ?>
				<?php
