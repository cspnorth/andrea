...
//					'option3' => 'Enable social sharing.',
	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
			array(
				...
				'options' => array(
					array( 'name' => 'Default',               'value' => 'option1', true ),
					array( 'name' => 'Style 1 (traditional)', 'value' => 'option2', true ),
					array( 'name' => 'Style 2 (grid layout)', 'value' => 'option3', true ),
				),
			),
			array(
				'name' => 'Team Layout',
			...
			array(
				...
				'options' => array(
					array( 'name' => 'Default',                 'value' => 'option1', true ),
					array( 'name' => 'Style 1 (dark overlay)',  'value' => 'option2', true ),
					array( 'name' => 'Style 2 (color overlay)', 'value' => 'option3', true ),
				),
			),			
			array(
				'name' => 'Team Content',
		...
		'fields'     => array(
			array(
				...
				'options' => array(
					...
					array( 'name' => 'Style 3', 'value' => 'option4', true ),
				),
			),
		),
	);
	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
			...
			array(
				'name'    => 'Portfolio Links Style',
				'desc'    => 'Choose a style for the portfolio hover area.',
				'id'      => $prefix . 'meta_portfoliolinksswitch',
				'type'    => 'radio',
				'options' => array(
					array( 'name' => 'Default', 'value' => 'option1', ),				
					array( 'name' => 'Style 1 (dark overlay)', 'value' => 'option2', ),
					array( 'name' => 'Style 2 (color overlay)', 'value' => 'option3', ),
				),
			),		
			array(
			...
			array(
				...
				'options' => array(
					...
					array( 'name' => 'Style 2 (button & grey background)', 'value' => 'option3', ),
				),
			),		
