	...
	if ( is_front_page() ) {
		...
		echo '<div id="section-home"><div id="section-home-inner">';
			...
			echo '<article class="section1 one_third">',
					...
					if ( empty( $thinkup_homepage_section1_icon ) ) {
						...
						if ( ! empty( $thinkup_homepage_section1_link ) ) {
							echo '<a href="' . esc_url( $thinkup_homepage_section1_link ) . '"' . esc_attr( $thinkup_homepage_section1_target ) . '><i class="' . esc_attr( $thinkup_homepage_section1_icon ) . ' fa-2x fa-inverse"></i></a>';
						} else {
							echo '<i class="' . esc_attr( $thinkup_homepage_section1_icon ) . ' fa-2x fa-inverse"></i>';
						}
					}
			echo	'</div>',
					...
					if ( ! empty( $thinkup_homepage_section1_link ) ) {
						echo '<p class="iconurl"><a class="" href="' . esc_url( $thinkup_homepage_section1_link ) . '"' . esc_attr( $thinkup_homepage_section1_target ) . '>' . esc_html( $thinkup_homepage_section1_button ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
			echo '<article class="section2 one_third">',
					...
					if ( empty( $thinkup_homepage_section2_icon ) ) {
						...
						if ( ! empty( $thinkup_homepage_section2_link ) ) {
							echo '<a href="' . esc_url( $thinkup_homepage_section2_link ) . '"' . esc_attr( $thinkup_homepage_section2_target ) . '><i class="' . esc_attr( $thinkup_homepage_section2_icon ) . ' fa-2x fa-inverse"></i></a>';
						} else {
							echo '<i class="' . esc_attr( $thinkup_homepage_section2_icon ) . ' fa-2x fa-inverse"></i>';
						}
					}
			echo	'</div>',
					...
					if ( ! empty( $thinkup_homepage_section2_link ) ) {
						echo '<p class="iconurl"><a class="" href="' . esc_url( $thinkup_homepage_section2_link ) . '"' . esc_attr( $thinkup_homepage_section2_target ) . '>' . esc_html( $thinkup_homepage_section2_button ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
			...
			echo '<article class="section3 one_third last">',
					...
					if ( empty( $thinkup_homepage_section3_icon ) ) {
						...
						if ( ! empty( $thinkup_homepage_section3_link ) ) {
							echo '<a href="' . esc_url( $thinkup_homepage_section3_link ) . '"' . esc_attr( $thinkup_homepage_section3_target ) . '><i class="' . esc_attr( $thinkup_homepage_section3_icon ) . ' fa-2x fa-inverse"></i></a>';
						} else {
							echo '<i class="' . esc_attr( $thinkup_homepage_section3_icon ) . ' fa-2x fa-inverse"></i>';
						}
					}
			echo	'</div>',
				...
				if ( ! empty( $thinkup_homepage_section3_link ) ) {
					echo '<p class="iconurl"><a class="" href="' . esc_url( $thinkup_homepage_section3_link ) . '"' . esc_attr( $thinkup_homepage_section3_target ) . '>' . esc_html( $thinkup_homepage_section3_button ) . '</a></p>';
				}
			echo	'</div>',
					'</div>',
				'</article>';
...
global $thinkup_homepage_introactioncustom1;
	...
	if ( $thinkup_homepage_introswitch == '1' and is_front_page() and ! empty( $thinkup_homepage_introaction ) ) {
		...
		echo '<div id="introaction"' . $style . '><div id="introaction-core">';
...
global $thinkup_homepage_outrostyle;
...
global $thinkup_footer_outrostyle;
...
global $thinkup_footer_outroactioncustom1;
	...
	if ( $thinkup_homepage_outroswitch == '1' and is_front_page() and ! empty( $thinkup_homepage_outroaction ) ) {
		...
		// Determine style for call to action
		if ( empty( $thinkup_homepage_outrostyle ) or $thinkup_homepage_outrostyle == 'option1' ) {
			$thinkup_homepage_outrostyle = ' class="style1"';
		} else if ( $thinkup_homepage_outrostyle == 'option2' ) {
			$thinkup_homepage_outrostyle = ' class="style2"';
		}

		echo '<div id="outroaction"><div id="outroaction-core"' . $thinkup_homepage_outrostyle . '>';
			echo '<div class="action-text">',
			...
			if ( ( !empty( $thinkup_homepage_outroactionlink1) and $thinkup_homepage_outroactionlink1 !== 'option3' ) ) {
				...
				// Set default value of buttons to "Read more"
				if( empty( $thinkup_homepage_outroactiontext1 ) ) { $thinkup_homepage_outroactiontext1 = __( 'Read More', 'experon' ); }
		...
		// Determine style for call to action
		if ( empty( $thinkup_footer_outrostyle ) or $thinkup_footer_outrostyle == 'option1' ) {
			$thinkup_footer_outrostyle = ' class="style1"';
		} else if ( $thinkup_footer_outrostyle == 'option2' ) {
			$thinkup_footer_outrostyle = ' class="style2"';
		}

		echo '<div id="outroaction"><div id="outroaction-core"' . $thinkup_footer_outrostyle . '>';
			echo '<div class="action-text">',
			...
			if ( ( !empty( $thinkup_footer_outroactionlink1) and $thinkup_footer_outroactionlink1 !== 'option3' ) ) {
				...
				// Set default value of buttons to "Read more"
				if( empty( $thinkup_footer_outroactiontext1 ) ) { $thinkup_footer_outroactiontext1 = __( 'Read More', 'experon' ); }
