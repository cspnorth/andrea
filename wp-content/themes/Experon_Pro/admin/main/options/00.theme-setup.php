...
function thinkup_theme_register_required_plugins() {
    ...
    $config = array(
        ...
        'message'           => '',
        'strings'           => array(
            'page_title'                                => __( 'Install Required Plugins', 'experon' ),
            'menu_title'                                => __( 'Install Plugins', 'experon' ),
            'installing'                                => __( 'Installing Plugin: %s', 'experon' ),
            'oops'                                      => __( 'Something went wrong with the plugin API.', 'experon' ),
            ...
            'return'                                    => __( 'Return to Required Plugins Installer', 'experon' ),
            'plugin_activated'                          => __( 'Plugin activated successfully.', 'experon' ),
            'complete'                                  => __( 'Plugin(s) installed and activated successfully. %s', 'experon' ),
        )
    );
