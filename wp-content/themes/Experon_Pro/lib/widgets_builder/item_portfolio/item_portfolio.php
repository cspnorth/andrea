...
class thinkup_builder_itemportfoliotheme extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[item_portfolio id="' . $post_id . '" link_icon="' . $link_icon . '" lightbox_icon="' . $lightbox_icon . '" links_style="' . $link_style . '" title="' . $toggle_title . '" details="' . $toggle_details . '" content_style="' . $content_style . '" size="' . $size . '"]' );
