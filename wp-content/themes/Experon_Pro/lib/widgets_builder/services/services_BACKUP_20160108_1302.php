	...
	function widget($args, $instance) {
		...
		if ( empty( $link ) ) {
			if ( empty( $style ) or $style == 'style1' ) {
				...
				if ( ! empty( $icon ) ) {
					$icon = '<i class="fa fa-' . $icon . ' fa-3x"></i>';
				}
			}
		} else {
			if ( empty( $style ) or $style == 'style1' ) {
				...
				$link = '<p class="iconurl"><a href="' . $link .'">' . $button . '</a></p>';
			} else {
				if ( ! empty( $icon ) ) {
					$icon = '<a href="' . $link . '"><i class="fa fa-' . $icon . ' fa-3x"></i></a>';
				}
				$link = '<p class="iconurl"><a class="themebutton2" href="' . $link .'">' . $button . '</a></p>';
			}
		}
