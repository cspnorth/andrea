...
function thinkup_register_teampost() {
	$labels = array(
		'name'               => _x( 'Team', 'post type general name', 'experon' ),
		'singular_name'      => _x( 'Team', 'post type singular name', 'experon' ),
		'add_new'            => _x( 'Add New', 'team', 'experon' ),
		'add_new_item'       => __( 'Add New Team', 'experon' ),
		'edit_item'          => __( 'Edit Team', 'experon' ),
		'new_item'           => __( 'New Team', 'experon' ),
		'view_item'          => __( 'View Team', 'experon' ),
		'search_items'       => __( 'Search Teams', 'experon' ),
		'not_found'          =>  __( 'No teams found', 'experon' ),
		'not_found_in_trash' => __( 'No teams found in Trash', 'experon' ),
		'parent_item_colon'  => '',
		'menu_name'          => __( 'Teams', 'experon' ),
	);
