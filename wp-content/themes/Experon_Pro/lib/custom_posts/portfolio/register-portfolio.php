...
function thinkup_register_portfoliopost() {
	$labels = array(
		'name'               => _x( 'Portfolio', 'post type general name', 'experon' ),
		'singular_name'      => _x( 'Portfolio', 'post type singular name', 'experon' ),
		'add_new'            => _x( 'Add New', 'portfolio', 'experon' ),
		'add_new_item'       => __( 'Add New Portfolio', 'experon' ),
		'edit_item'          => __( 'Edit Portfolio', 'experon' ),
		'new_item'           => __( 'New Portfolio', 'experon' ),
		'view_item'          => __( 'View Portfolio', 'experon' ),
		'search_items'       => __( 'Search Portfolios', 'experon' ),
		'not_found'          => __( 'No portfolios found', 'experon' ),
		'not_found_in_trash' => __( 'No portfolios found in Trash', 'experon' ),
		'parent_item_colon'  => '',
		'menu_name'          => __( 'Portfolio', 'experon' ),
	);
