...
function thinkup_register_clientpost() {
	$labels = array(
		'name'               => _x( 'Clients', 'post type general name', 'experon' ),
		'singular_name'      => _x( 'Client', 'post type singular name', 'experon' ),
		'add_new'            => _x( 'Add New', 'client', 'experon' ),
		'add_new_item'       => __( 'Add New Client', 'experon' ),
		'edit_item'          => __( 'Edit Client', 'experon' ),
		'new_item'           => __( 'New Client', 'experon' ),
		'view_item'          => __( 'View Client', 'experon' ),
		'search_items'       => __( 'Search Clients', 'experon' ),
		'not_found'          => __( 'No clients found', 'experon' ),
		'not_found_in_trash' => __( 'No clients found in Trash', 'experon' ),
		'parent_item_colon'  => '',
		'menu_name'          => __( 'Clients', 'experon' ),
	);
